    ...
    $(document).ready(function(){
       ...
       -------------------------------*/
        ...
        if ($testimonialOneCarousel.length > 0) {
            $testimonialOneCarousel.owlCarousel({
                ...
                animateIn: 'zoomIn',
                nav: true,
                navText:["<img src='./../img/icon/arrow-left-black.svg' alt='Arrow Icon'>","<img src='./../img/icon/arrow-right-black.svg' alt='Arrow Icon'>"],
                smartSpeed: 2000,
                responsive: {
                    0: {
                        items: 1
        ...
        if ($teamOneCarousel.length > 0) {
            $teamOneCarousel.owlCarousel({
                ...
                dots: true,
                nav: true,
                navText:["<img src='../../client/img/icon/arrow-left-black.svg' alt='Arrow Icon'>","<img src='../../client/img/icon/arrow-right-black.svg' alt='Arrow Icon'>"],
                smartSpeed: 2000,
                responsive: {
                    0: {
                        items: 1
        ...
        $('.latest-blog-slider-nav-content').slick({
            ...
            arrows: true,
            dots: false,
            prevArrow: '<a class="slick-prev"><img src="../img/icon/arrow-left-black.svg" alt="Arrow Icon"></a>',
            nextArrow: '<a class="slick-next"><img src="../img/icon/arrow-left-black.svg" alt="Arrow Icon"></a>',
            draggable: false,
            fade: true,
        ...
        $('.slider-one-active').slick({
            ...
            slidesToShow: 1,
            slidesToScroll: 1,
            prevArrow: '<span data-role="none" class="slick-next" aria-label="Next" tabindex="0"></span>',
            nextArrow: '<span data-role="none" class="slick-next" aria-label="Next" tabindex="0"></span>',
            responsive: [
                {
                    breakpoint: 1024,
        ...
        $('.slider-two-active').on('init reInit afterChange', function(event, slick, currentSlide, nextSlide){
            ...
            prevArrow: '<a class="slick-prev"><img src="../icon/arrow-right-white.svg" alt="Arrow Icon"></a>',
            nextArrow: '<a class="slick-next"><img src="../icon/arrow-left-white.svg" alt="Arrow Icon"></a>',
            responsive: [
                {
                    breakpoint: 1024,
                    settings: {
        ...
        $('.slider-three-active').on('init reInit afterChange', function(event, slick, currentSlide, nextSlide){
            ...
            slidesToShow: 1,
            slidesToScroll: 1,
            prevArrow: '<a class="slick-prev"><img src="../img/icon/arrow-right-black.svg" alt="Arrow Icon"></a>',
            nextArrow: '<a class="slick-next"><img src="../img/icon/arrow-left-black.svg" alt="Arrow Icon"></a>',
            responsive: [
                {
                    breakpoint: 1024,
        ...
        $('.slider-3-image-slide-active').slick({
            ...
            centerMode: true,
            focusOnSelect: true,
            prevArrow: '<a class="slick-prev"><img src="../img/icon/arrow-right-white.svg" alt="Arrow Icon"></a>',
            nextArrow: '<a class="slick-next"><img src="../img/icon/arrow-left-white.svg" alt="Arrow Icon"></a>'
        });
      ...
      -----------------------*/
        $('.slider-four-active').on('init reInit afterChange', function(event, slick, currentSlide, nextSlide){
            ...
            slidesToShow: 1,
            slidesToScroll: 1,
            prevArrow: '<a class="slick-prev"><img src="../icon/arrow-right-misti.svg" alt="Arrow Icon"></a>',
            nextArrow: '<a class="slick-next"><img src="../icon/arrow-left-misti.svg" alt="Arrow Icon"></a>',
            responsive: [
                {
                    breakpoint: 1024,
                    settings: {
