...
class __TwigTemplate_fb2d117956261a2bb6136fcb84c42dd7c2399e10b7c93aa1261bd2d672f27d55 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container\">
        ...
        echo "\" alt=\"Bloom\">
                            ...
                            <div class=\"title-text\">
                                <h2 class=\"title\">Regoinez-nous</h2>
                            </div>
                        </div>
                    </div>
                        ";
            ...
            <div class=\"col-xl-7 col-lg-8 col-md-6 col-12\">
                <div class=\"custom-content-image text-right margin-top-30 mobile-mt-50 tab-mt-50\">
                    <div class=\"img-shape\">
                        <img src=\"";
        // line 79
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("client/img/others/signin2.jpg"), "html", null, true);
        echo "\" alt=\"\">
                    </div>
                </div>
            </div>
    ...
    <div class=\"container\">
        <div class=\"row custom-gutter\">
            ...
            <div class=\"col-xl-7 col-lg-8 col-md-6 col-12\">
                <div class=\"custom-content-image text-right margin-top-30 mobile-mt-50 tab-mt-50\">
                    <div class=\"img-shape\">
                        <img src=\"{{ asset('client/img/others/signin2.jpg')}}\" alt=\"\">
                    </div>
                </div>
            </div>
            </div>
...
{% endblock %}
", "registration/index.html.twig", "/home/chloriq/www/ChlorisFlowersProd/templates/registration/index.html.twig");
    }
}
