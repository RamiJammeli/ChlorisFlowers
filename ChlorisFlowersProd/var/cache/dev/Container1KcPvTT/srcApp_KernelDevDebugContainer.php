...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/product'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], 'https');
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/order'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], 'https');
